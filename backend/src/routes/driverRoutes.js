...
router.post('/', authorize('Safety Officer', 'Fleet Manager'), driverController.addDriver);
...
// @access  Private (Safety Officer, Fleet Manager)
router.put('/:id', authorize('Safety Officer', 'Fleet Manager'), driverController.updateDriver);

// @route   DELETE /api/drivers/:id
// @desc    Delete a driver profile
// @access  Private (Safety Officer, Fleet Manager)
router.delete('/:id', authorize('Safety Officer', 'Fleet Manager'), driverController.deleteDriver);
