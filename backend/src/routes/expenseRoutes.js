...
router.post('/', authorize('Financial Analyst', 'Fleet Manager'), expenseController.addExpense);
...
router.get('/monthly', authorize('Financial Analyst'), expenseController.getMonthlyExpenses);

// @route   GET /api/expenses/report
// @desc    Get a full operational cost report per vehicle (fuel + maintenance + expenses)
// @access  Private (Financial Analyst)
router.get('/report', authorize('Financial Analyst'), expenseController.getExpenseReport);
...
// @access  Private (Financial Analyst, Fleet Manager)
router.put('/:id', authorize('Financial Analyst', 'Fleet Manager'), expenseController.updateExpense);

// @route   DELETE /api/expenses/:id
// @desc    Delete an expense
// @access  Private (Financial Analyst, Fleet Manager)
router.delete('/:id', authorize('Financial Analyst', 'Fleet Manager'), expenseController.deleteExpense);
