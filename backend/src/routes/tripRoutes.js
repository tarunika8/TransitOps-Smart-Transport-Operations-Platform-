...
router.post('/', authorize('Driver', 'Fleet Manager'), tripController.createTrip);
...
// @access  Private (Driver, Fleet Manager)
router.put('/:id', authorize('Driver', 'Fleet Manager'), tripController.updateTrip);
...
// @access  Private (Driver, Fleet Manager)
router.put('/:id/start', authorize('Driver', 'Fleet Manager'), tripController.startTrip);

// @route   PUT /api/trips/:id/end
// @desc    End (complete) a trip — sets vehicle & driver status back to "Available"
// @access  Private (Driver, Fleet Manager)
router.put('/:id/end', authorize('Driver', 'Fleet Manager'), tripController.endTrip);

// @route   PUT /api/trips/:id/cancel
// @desc    Cancel a Draft or Dispatched trip
// @access  Private (Driver, Fleet Manager)
router.put('/:id/cancel', authorize('Driver', 'Fleet Manager'), tripController.cancelTrip);
